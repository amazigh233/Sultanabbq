...
window.SultanaAnimations = (() => {
    ...
    function animateHero() {
        const steps = [
            ['.hero-subtitle', { opacity: 1, y: 0, duration: 1, ease: 'power3.out' }, undefined],
            ['.hero-title', { opacity: 1, y: 0, duration: 1.2, ease: 'power3.out' }, '-=0.6'],
            ['.hero-tagline', { opacity: 1, y: 0, duration: 1, ease: 'power3.out' }, '-=0.7'],
            ['.hero-description', { opacity: 1, y: 0, duration: 1, ease: 'power3.out' }, '-=0.6'],
            ['.hero-cta', { opacity: 1, y: 0, duration: 0.8, ease: 'power3.out' }, '-=0.4']
        ];
        const tl = gsap.timeline({ delay: 1.5 });

        steps.forEach(([selector, vars, position]) => {
